...
| calico.targetRevision | string | `"v3.30.3"` |  |
...
| coreDNS.targetRevision | string | `"1.43.1"` |  |
...
| karpenter-crds.secondary.additionalTags | object | `{}` |  |
...
| karpenter-crds.secondary.requirements[0].values[1] | string | `"spot"` |  |
| karpenter-crds.secondary.requirements[1].key | string | `"kubernetes.io/arch"` |  |
| karpenter-crds.secondary.requirements[1].operator | string | `"In"` |  |
| karpenter-crds.secondary.requirements[1].values[0] | string | `"amd64"` |  |
| karpenter-crds.secondary.requirements[2].key | string | `"karpenter.k8s.aws/instance-category"` |  |
| karpenter-crds.secondary.requirements[2].operator | string | `"In"` |  |
| karpenter-crds.secondary.requirements[2].values[0] | string | `"c"` |  |
| karpenter-crds.secondary.requirements[2].values[1] | string | `"m"` |  |
...
| karpenter-crds.useAlias | bool | `false` |  |
...
| karpenter.targetRevision | string | `"1.0.8"` |  |
